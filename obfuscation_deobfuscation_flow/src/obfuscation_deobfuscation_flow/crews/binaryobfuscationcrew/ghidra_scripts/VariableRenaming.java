...
public class VariableRenaming extends GhidraScript {
    ...
    public void run() throws Exception {
        // Initialize count for renamed variables
        int count = 0;
    ...
    // Helper function to check if the new name is already taken by another variable
    // in the function
    ...
    // Helper function to export the modified program
    private void exportModifiedProgram() {
        try {
            // Define the output path for the modified binary file
            File outputFile = new File(
                    "C:\\Users\\celin\\Desktop\\usj\\FYP\\agentic_obfuscator_deobfuscator_system\\obfuscation_deobfuscation_flow\\src\\obfuscation_deobfuscation_flow\\crews\\binaryobfuscationcrew\\ghidra_output\\obfuscated_binary.exe");
            ...
            // Export with full memory from the image base
